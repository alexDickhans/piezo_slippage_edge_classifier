/*
  ...
  ---------------------------------------------------------------------------  
    float input_data[200]; // AIfES input data
...
{
  uint32_t FNN_structure[FNN_LAYERS] = {200, 64, 32, 1};
  ...
  AIFES_E_activations FNN_activations[] = {AIfES_E_relu, AIfES_E_relu, AIfES_E_sigmoid};
